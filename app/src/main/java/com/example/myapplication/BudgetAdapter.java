 ...
 * - Color-coded warnings (red if exceeded, orange if >80%)
...
public class BudgetAdapter extends RecyclerView.Adapter<BudgetAdapter.BudgetViewHolder> {
    ...
    /**
     * Interface for handling budget item click events.
     */
    public interface OnBudgetClickListener {
        void onEditClick(DataManager.Budget budget);    // Called when edit is clicked
        void onDeleteClick(DataManager.Budget budget);  // Called when delete is clicked
    }
